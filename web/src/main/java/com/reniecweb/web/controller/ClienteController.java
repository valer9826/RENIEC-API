...
import com.reniecweb.web.repository.ClienteRepository;
import com.reniecweb.web.repository.UsuarioRepository;
...
public class ClienteController {
    ...
    private static final String INDEX ="cliente/register"; 
    ...
    public String createSubmitForm(Model model, 
        ...
        if(result.hasFieldErrors()) {
            model.addAttribute("mensaje", "Error al registrarse");
        }else{
